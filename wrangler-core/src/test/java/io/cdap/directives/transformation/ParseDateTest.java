...
public class ParseDateTest {
  ...
  public void testSimpleDateWithPatterns() throws Exception {
    ...
    Assert.assertEquals(pstDateTime.withNano(111000000), rows.get(0).getValue("date9")); // Fixed: Expect UTC 14:45:11
    Assert.assertEquals(zonedDateTime.withNano(111000000), rows.get(0).getValue("date10"));
